...
5. Copy and paste the skill into the chat; tell the agent to save it. 
6. Start a new conversation — Claude connects to Orbit automatically at the start of the session.
